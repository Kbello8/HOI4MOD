...
NMilitary = {
	...
	FRONT_MIN_PATH_TO_REDEPLOY = 14,					-- If a units path is at least this long to reach its front location, it will strategically redeploy.
...
NAI = {
	...
	DIVISION_CREATE_MIN_XP = 200,				-- Minimum XP before attempting to create a fresh new division template.
	...
	GIVE_STATE_CONTROL_NEIGHBOR_ACTOR_SCORE = -50, -- Diplo score for each neighboring state that is controlled by the sender
	GIVE_STATE_CONTROL_NEIGHBOR_OTHER_SCORE = 30, -- Diplo score for each neighboring state controlled by someone else
	GIVE_STATE_CONTROL_MAX_SCORE_DIST = 200,	-- A State that is closer to the recipient capital than this gets a score bonus based on the below value
	...
	ENTRENCHMENT_WEIGHT = 5.0,					-- AI should favour units with less entrenchment when assigning units around.
	...
	BUILD_REFINERY_LACK_OF_RESOURCE_MODIFIER = 0.1,	-- How much lack of resources are worth when evaluating what to build.
