...
NAI = {
	...
	DIVISION_UPGRADE_MIN_XP = 15,				-- Minimum XP before attempting to upgrade a division template.
	DIVISION_CREATE_MIN_XP = 400,				-- Minimum XP before attempting to create a fresh new division template.
	VARIANT_UPGRADE_MIN_XP = 250,				-- Minimum XP before attempting to create a new variant.
